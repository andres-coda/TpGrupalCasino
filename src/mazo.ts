/* La clase mazo es la encargada de darle nombre a las cartas, y agruparlas en mazos. Por palo y por mazo de cuatro palos. 
 cuenta con el mazo en si, que es un arreglo de cartas ordenadas, y el descarte que es un arreglo que contiene
 los indice del mazo que fueron utilizados por el juego mayor menor
 
 Los metodos que tiene son modificar mazo(setMazo), leer mazo (getMazo) te devuelve el mazo,
 te devuelve el nombre de la carta,  cargar palo, cargar mazo, y dar cartas*/
